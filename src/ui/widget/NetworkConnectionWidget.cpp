...
{
    // if empty, try to connect using the values already in server and port line edits

    if (szOption.isEmpty() == false) {
...
{
    Q_EMIT signalButtonConnectToServerToggled(bButtonState);
